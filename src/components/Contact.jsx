...
const Contact = () =>{
    return (
        ...
        <section className='contact'>
            <p>
                As we pride our self to being one with our clients we belive in having the
                persnal conversation to gain the vision of our client and build a better dream 
                or design for the so for more information about our work you can have a personal chat with the 
                designer on our social media platform or send us an email we will get back to you 
                as soon as possible!!.
            </p>
            <div className="socials">
               <div style={{display:'flex'}} className='whatsapp'>
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                   ...
                   <Flip right>
                   <a href="http://" style={{color:'black'}}>Emidio Faustino Xai-Xai</a>
                   </Flip>
                </div>
  ...
  <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.354-1.646a.5.5 0 0 1-.722-.016l-1.149-1.25a.5.5 0 1 1 .737-.676l.28.305V11a.5.5 0 0 1 1 0v1.793l.396-.397a.5.5 0 0 1 .708.708l-1.25 1.25Z"/>
                   ...
                   <Slide right>
                   <a href="http://Xaixaiemidiofaustion@gmail.com" style={{color:'black'}}>Xaixaiemidiofaustion@gmail.com</a>
                   </Slide>
                 </div>
            </div>
        </section>
